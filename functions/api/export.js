    ...
    try {
        ...
        if (mode === 'solo') {
            ...
            for (let t of duoList) {
                ...
                script += `wget -U "Mozilla/5.0 (Windows NT 10.0; Win64; x64)" -O "${targetDir}/Duo/${n1}__${n2}__${tag}${suf}.png" "${urlDuo1}"\n`;
                ...
                script += `wget -U "Mozilla/5.0 (Windows NT 10.0; Win64; x64)" -O "${targetDir}/Duo/${n2}__${n1}__${tag}${suf}.png" "${urlDuo2}"\n`;
            }
            script += "\n";
        }
